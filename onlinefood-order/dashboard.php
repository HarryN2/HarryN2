            ...
            while($row=mysqli_fetch_assoc($res2))
            {
                ...
                <div class="food-menu-box">
                    ...
                    <a href="<?php echo SITEURL; ?>order.php?food_id=<?php echo $id; ?>" class="btn btn-primary">Order Now</a>
                      <!--  <a href="car.php" classs="btn btn-primary"  name="quantity">Order Now</a> <!-- 
                      <a href="<?//php echo SITEURL; ?>car.php?food_id=<?//php echo $id; ?>" class="btn btn-primary">Order Now</a>
 -->
<!-- <a href="ca.php" class="btn btn-primary" name="add_to_cart" value="add to cart">Order Now</a> -->
                </div>
